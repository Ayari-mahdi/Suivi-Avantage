...
export class PaymentDataTableDataSource extends DataSource<PaymentDataTableItem> {
   ...
   */
  private getPagedData(data: PaymentDataTableItem[]): PaymentDataTableItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: PaymentDataTableItem[]): PaymentDataTableItem[] {
